...
def main():
    ...
    st.write(
            ...
            <p style="text-align: center; color: #dee2e6; font-size: 20px;"><i>
                This is a demo application for the project Vietnamese Handwritten Recognition @Aptech. <br>
                <strong><u>Authors:</strong></u> Phạm Cao Sang, Võ Khánh Linh , Trần Nguyễn Thảo Nguyên, Trần Ngọc Anh <br>
                <strong><u>Instructors:</strong></u> Mr. Trần Hữu Nhân ,  Ms. Phùng Khánh Linh
            </i></p> 
            """,
            unsafe_allow_html=True
        )
    ...
    model_version = st.selectbox('Select Model Version:', ['config_v3', 'config_v1'])
    # Select box for weights
    weights_files = ['transformerocr_v3', 'transformerocr_v1']
    weights_file = st.selectbox('Select Weights:', weights_files)
    ...
    if uploaded_file is not None:
        ...
        st.write(
            ...
            <strong><u>Recognized Text: </strong></u>
            </p> 
            """,
            unsafe_allow_html=True
        )
